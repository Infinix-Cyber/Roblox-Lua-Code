print("🚀 EXTRA'S AI — NVIDIA EDITION (FINAL)")
...
task.spawn(function()
    task.wait(1.5)
    sendMsg("🚀 EXTRA'S AI — NVIDIA EDITION")
    task.wait(0.6)
    sendMsg("✅ 100% working — no tokens needed!")
    task.wait(0.6)
...
Be friendly, polite, supportive and creative.
    ...
    if ok and res and res.choices and res.choices[1] then
        ...
        print("⚠️ NVIDIA API error — checking connection...")
        return nil
    end
end
...
local function connectToAllChatSystems()
    ...
    if connected == 0 then
        warn("⚠️ No chat systems connected!")
    else
...
task.spawn(function()
    ...
    print("🚀 EXTRA'S AI — NVIDIA EDITION LOADED")
    print("✅ Model: nvidia/llama-3.1-nemotron-70b-instruct")
    print("✅ No tokens needed — 100% working")
...
local function createGUI()
    ...
    s.Text = "NVIDIA EDITION — 2s delay"
    ...
    tog.MouseButton1Click:Connect(function()
        ...
        st.Text = isEnabled and "✅ No tokens needed" or "❌ Disabled"
